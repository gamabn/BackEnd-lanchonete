...
exports.OrderSalesService = void 0;
...
class OrderSalesService {
    async execute({ restaurant_id, customer_id, status, total_price, payment_method, change_for }) {
        const client = await database_1.pool.connect();
        try {
            await client.query('BEGIN');
            const orderSales = await client.query('INSERT INTO orders(restaurant_id, customer_id, status, total_price, payment_method, change_for) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *', [restaurant_id, customer_id, status, total_price, payment_method, change_for]);
            const order = orderSales.rows[0];
...
exports.OrderSalesService = OrderSalesService;
