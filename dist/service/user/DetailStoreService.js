...
exports.DetailStoreService = void 0;
const database_1 = require("../../database");
class DetailStoreService {
    async execute(user_id) {
        try {
            const store = await database_1.pool.query('SELECT * FROM restaurants WHERE id = $1', [user_id]);
...
exports.DetailStoreService = DetailStoreService;
